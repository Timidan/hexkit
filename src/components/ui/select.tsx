 ...
 * Usage:
 *   <SelectTrigger>
 *     <AnimatedSelectValue value={currentValue} placeholder="pick…" />
 *   </SelectTrigger>
 */
function AnimatedSelectValue({
  value,
  placeholder,
  className,
}: {
  ...
  return (
    <span
      ...
      className={cn("relative inline-flex items-center gap-2 overflow-hidden", className)}
    >
      {/* Hidden Radix primitive — keeps Select internals working */}
